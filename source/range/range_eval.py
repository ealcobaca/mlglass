...
def run_eval(data_path, str_class, n_cpus):
    ...
    result_path = "../../result/result_oracle/regressors_obj"
    ...
    for alg_low in algs:
        for alg_middle in algs:
            for alg_high in algs:
                ...
                counter = counter + 1
                print(counter)
                pickle.dump(d, open(result_path+"regressors_obj/dic_regressors_v{0}.data".format(counter), "wb"))
    pickle.dump(d, open(result_path+"regressors_obj/dic_regressors.data", "wb"))
